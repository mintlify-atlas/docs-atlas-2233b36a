...
description: "Common questions about Athena framework, setup, costs, and troubleshooting"
---

## General

<Accordion title="What is Athena?">
...
<Accordion title="Is this just a prompt library?">
...
<Accordion title="Which AI models does Athena support?">
...
<Accordion title="Does it work with Cursor? Windsurf?">
...
<Accordion title="I already have a project — do I need to move it into Athena?">
No. Three options:
...
<Accordion title="I work with clients — where does their data go?">
...
<Accordion title="What's the boot time?">
| Mode | Time |
|------|------|
...
<Accordion title="Is it safe to use for work?">
